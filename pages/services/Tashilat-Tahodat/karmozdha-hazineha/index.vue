<template src="./karmozdha-hazinehaPage.html"></template>
<style lang="scss" src="./karmozdha-hazinehaPage.scss" scoped></style>
  ...
  methods: {
    GetMorabeheTitle: function () {
      ...
      axios.get(endPointUrl).then((response) => {       
        this.KarmozdTitle = response.data.value;
      });
    ...
    GetMorabeheItems: function () {
      ...
      axios.get(endPointUrl).then((response) => {
        this.KarmozdItems = response.data.value;
      });
    },
    GetLink: function () {
      var endPointUrl =
