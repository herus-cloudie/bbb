...
export default Vue.extend({
  ...
  methods: {
    GetLogoSaderat: function () {
      var endPointUrl =
        this.SiteAdrs +
        "/_api/web/lists/getbyTitle('کتابخانه نام و نشان تجاری')/items?$select=Id,LinkFilename,Title&$filter=IsActive%20eq%201%20and%20Position%20eq%20'لوگوهای بانک صادرات ایران'&$orderby=Order0";
